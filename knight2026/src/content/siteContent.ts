...
export const aboutCopy = {
  ...
  ko: {
    ...
    body:
      'Bay Area K-Group(BAKG)은 실리콘밸리 지역에서 테크 분야에 종사하는 한인들의 자발적 조직입니다. 정기적으로 컨퍼런스와 네트워킹 행사를 통해 회원들간의 기술 교류와 친목도모를 돕고 있으며,\n다양한 기술분야와 취미에 따라 여러 소모임들이 자율적으로 운영되고 있습니다.',
    teamTitle: '팀소개',
    teamDescription:
...
export const donationCopy = {
  en: {
    ...
    benefits: [
      ['An Open Community', 'Keeping K-Group free and accessible to Korean professionals across Silicon Valley’s tech community'],
      ['Professional Networks', 'Supporting groups that connect professionals, share knowledge, and exchange ideas across the industry.'],
      ['Knowledge & Opportunities', 'Connecting the next generation with Silicon Valley’s knowledge, experience, and opportunities.'],
    ],
  ...
  ko: {
    ...
    subtitle: 'Together, We Grow',
    supportSubtitle: 'Bay Area K-Group은 후원 규모와 관계없이 개인 및 기업 여러분의 소중한 후원을 언제나 환영합니다.',
    ...
    benefits: [
      ['열린 커뮤니티 유지', '실리콘밸리에서 테크 관련 분야에 종사하는 한인이라면 누구나 가입비 없이 참여할 수 있는 기회의 장 제공'],
      ['전문 소모임 지원', '급변하는 테크 트렌드에 맞춘 직군별·기술별 전문 네트워크 활성화'],
      ['나눔과 연결', '다음 세대 한인 인재들에게 실리콘밸리의 노하우와 기회 전달'],
    ],
    getInTouch: '문의하기',
  },
} as const
...
export const donationSupportCopy = {
  en: {
    ...
    address: 'Mailing Address: P.O Box 60424, 209 East Java Dr., Sunnyvale, CA 94086',
    matchingTitle: 'Corporate Matching',
    matchingHighlight: 'Increase your support impact by 200% through company benefits',
    matchingHighlightBody: 'Consider using corporate donation matching programs available in Silicon Valley. Your contribution can become two or three times larger for K-Group.',
    matchingBody: 'Many companies offer Gift-Matching programs that add a contribution equal to an employee’s donation.',
    matchingExample: 'Example: Donate $50 to K-Group through your company Giving Portal and request a match. Your company may contribute $50 or more, creating a total impact of $100 or more.',
    matchingSearch: 'Search for “Bay Area K-Group” in your company HR or Giving Portal.',
    volunteerTitle: 'Volunteer Grant',
    volunteerBody: 'Even if you do not donate money, your time can become a contribution. If you have served as K-Group staff or a volunteer, you may request corporate support for your service hours through a Volunteer Grant program.',
    taxNote: 'Bay Area K-Group is a 501(c)(3) nonprofit organization registered with the IRS (EIN: 51-0656931). Your contribution is used transparently for community operations and may be tax-deductible. (Corporate and individual support are both welcome.)',
    ctaBody: [
  ...
  ko: {
    ...
    matchingHighlightBody: '실리콘밸리에 있는 기업들이 제공하는 기부 매칭 프로그램을 활용해 보세요. 여러분의 후원금이 2배, 3배가 되어 K-Group에 전달됩니다.',
    matchingBody: '많은 기업이 직원의 기부액만큼 추가로 기부해 주는 Gift-Matching 프로그램을 운영하고 있습니다.',
    matchingExample: '예시: 사내 Giving Portal을 통해 K-Group에 $50을 기부하고 매칭을 신청하면, 회사에서 $50(또는 그 이상)을 추가로 기부해 총 $100 이상의 후원 효과가 발생합니다.',
    matchingSearch: "지금 다니시는 회사의 인사 시스템(HR/Giving Portal)에서 'Bay Area K-Group'을 검색해 보세요.",
    volunteerTitle: '자원봉사 지원금',
    volunteerBody: '돈을 기부하지 않더라도, 여러분의 시간도 기부금이 될 수 있습니다. K-Group에서 스태프나 자원봉사자로 활동하신 경우, 기업의 Volunteer Grant 제도를 통해 봉사 시간만큼의 지원금을 K-Group으로 요청하실 수 있습니다.',
    taxNote: 'Bay Area K-Group은 미국세청에 등록된 501(c)(3) 비영리 단체(EIN: 51-0656931)로, 보내주신 후원금은 전액 커뮤니티 운영에 투명하게 사용되며 세금 공제(Tax-deductible) 혜택을 받으실 수 있습니다. (기업/개인 후원 모두 가능)',
    ctaBody: [
...
export const ticketCopy = {
  en: {
    ...
    noticeItems: [
      ...
      ['Seat', 'This is a general admission event with open seating (no assigned seats).'],
      ['Tickets May Sell Out', 'Tickets are limited and may sell out before the event, so we encourage you to reserve yours early.'],
      ['Registration & Refund Deadline', 'Ticket purchases and refunds will be available until Thursday, September 10 at 5:00 PM (PT).'],
      ['No On-site Ticket Sales', 'Tickets must be purchased in advance. No tickets will be sold at the venue on the day of the event.'],
      ['No Minors Allowed', 'Guests under 18 will not be admitted.'],
      ['Language', 'The event will be conducted primarily in Korean.'],
      ['No Livestream or Recordings', 'K-Night will not be livestreamed or recorded for later viewing. All sessions are available exclusively to in-person attendees.'],
    ],
  ...
  ko: {
    ...
    noticeItems: [
      ...
      ['매진 유의', '준비된 티켓이 조기에 마감 될 수 있으니 구매를 서둘러 주세요.'],
      ['사전 예매 및 환불', '9/10(목) 오후 5시까지만 가능합니다.'],
      ['현장 판매 없음', '모든 티켓은 사전 구매로만 판매되며, 행사 당일 현장 판매는 진행하지 않습니다.'],
      ['미성년자 입장 불가', '본 행사에는 미성년자가 동반 및 입장할 수 없습니다.(No Minors Allowed)'],
      ['진행 언어', '본 행사는 한국어로 진행되며, 부분적으로 영어를 사용합니다.'],
      ['스트리밍 및 녹화본 미제공', 'K-Night은 유튜브 스트리밍 및 행사 후 녹화본을 공유하지 않습니다. 모든 세션은 오직 행사 당일 현장에서만 공개됩니다.'],
    ],
    carpoolTitle: '교통안내',
