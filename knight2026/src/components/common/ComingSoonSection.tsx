    ...
    >
      ...
      <div className="relative z-10 flex w-full flex-col items-center">
        <Stagger
          ...
          className="flex w-full max-w-[768px] flex-col items-center gap-6 px-4 text-center max-md:gap-4 md:px-10"
        >
          <StaggerItem>
            <EventBadge subdued />
          </StaggerItem>
          ...
          <StaggerItem className="w-full pt-4 max-md:pt-2">
          ...
          <StaggerItem
            ...
            className="flex w-full flex-wrap items-center justify-center gap-3 pt-8 max-md:flex-col max-md:items-stretch max-md:gap-2 max-md:pt-4"
          >
            <Button
        ...
        <VideoSection videoSrc={videoSrc} showBackground={false} />

        <Stagger
          variants={staggerContainerSlow}
          className="flex w-full max-w-[768px] flex-col items-center gap-6 px-4 text-center max-md:gap-4 md:px-10"
        >
          <StaggerItem className="flex w-full flex-col items-center pt-8 max-md:pt-4">
